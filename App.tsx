...
export default function App() {
  ...
  const [newChallengeCategory, setNewChallengeCategory] =
    useState<ChallengeCategory>(ChallengeCategory.POSITIVITY);
      ...
      <header className="px-6 py-6 bg-white rounded-b-3xl shadow-sm z-10">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="p-2 bg-stone-100 rounded-full text-stone-400 hover:bg-stone-200"
          >
            <Coffee size={18} />
          </button>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-stone-400 mt-2">
              다음 레벨까지 {nextLevelInfo ? nextLevelInfo.minXp - user.xp : 0}{" "}
              XP 남았어요
            </p>
          </div>
        </div>
          ...
          <div className="space-y-6 pb-24">
            ...
            {completedChallenges.length > 0 && (
              <div className="opacity-60">
                <h2 className="text-sm font-bold text-stone-400 mb-3 mt-8">
                  완료한 일들
                </h2>
                <div className="space-y-3">
      ...
      <nav className="bg-white border-t border-stone-100 px-6 py-4 flex justify-around items-center z-30 pb-safe">
        <button
          ...
          className={`flex flex-col items-center gap-1 ${
            activeTab === "home" ? "text-stone-800" : "text-stone-300"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 ${
            activeTab === "social" ? "text-stone-800" : "text-stone-300"
          }`}
        >
        ...
        <div className="fixed inset-0 bg-black/20 z-50 flex items-end sm:items-center justify-center p-4 backdrop-blur-sm animate-fade-in">
          <div className="bg-white w-full max-w-sm rounded-2xl p-6 shadow-2xl mb-4 sm:mb-0">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-xs text-stone-500 font-medium mb-2 block">
                  어떤 종류인가요?
                </label>
